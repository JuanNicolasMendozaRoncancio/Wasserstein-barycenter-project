...
https://github.com/dan-mim/Computing-Wasserstein-Barycenters-MAM?tab=readme-ov-file


This repository is my owrk on the research trimester from the first year of my masters a Mines Paris PSL. The structure is:
...
```
  └──MAM
      ...
      ├── LICENSE
      ├── README.md
      └── understandigMAM.ipynb     # Notebook were I review the previous code
  └──Papers                         #Folder were all of the biblio can be found
```